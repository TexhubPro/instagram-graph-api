...
final class CurlTransport implements Transport
{
    public function __construct(
        ...
        private readonly string $userAgent = 'texhub-instagram-graph-api/1.0 (+https://texhub.pro)',
    ) {
    }
    ...
    public function request(
        ...
        if ($errorNo !== 0 || $body === false) {
            throw new TransportException(sprintf('Instagram request to %s failed: %s', $url, $error ?: 'unknown cURL error'));
        }
